...
# ╔═╡ 09828d6c-5d69-4163-bce7-c5b4ed3a3067
using Plots

# ╔═╡ 41d90cd6-59ba-4fa7-ac63-7fcdaa7eb4ca
using TestImages, ImageShow, ImageIO
...
md"""
# Julia
A relatively new dynamic programming language (≈ 5 years since 1.0)
...
# ╔═╡ e4d3ea8a-d877-414a-b07c-97f900fe9e52
@time sum_positive(Γ)

# ╔═╡ df4bb219-2bd1-474b-8d76-e7a1045bed4f
...
# ╔═╡ a9de08cb-8b7d-4972-b771-ca09d6b07d14


# ╔═╡ c5be5622-a8ba-473a-b4e6-9e7f059b9ea1
md"# Plots"

# ╔═╡ 07cd15c2-2eb3-4295-9794-8a591b98975c
x = 0:0.01:8

# ╔═╡ fd0de2f0-aaa6-4666-b7ff-bc6498b40769
@bind offset Slider(0:0.02:3, show_value=true)

# ╔═╡ 2858d628-dd86-4570-9f9e-e4cdf6f86eec
plot(x, sin.(x .+ offset))

# ╔═╡ 3e4b0987-437e-4cf6-8370-ea118a6f0e82
md"# Images"
...
manifest_format = "2.0"
project_hash = "c05bfd67bcb614cf6275dd00f8cb657a71aa2f47"
