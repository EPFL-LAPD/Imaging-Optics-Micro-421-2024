...
# ╔═╡ 446b9a47-1d36-496e-a3e8-4213ba94e79f
TODO

# ╔═╡ afa614ec-b048-420e-b584-bdcfcf7722dc


# ╔═╡ d879bbff-1271-479b-9d38-cd10950afaeb
...
res0 = confocal_microscope(img_small, aperture_illumination, aperture_imaging, pinhole1);
...
[simshow(res0) simshow(res1) simshow(res2) simshow(res3) simshow(res4) simshow(res10) simshow(res20) simshow(res100) simshow(res_widefield)]
