...
# ╔═╡ 3ed0d447-0cbd-480c-8517-6714265e0778
...
# ╔═╡ 2a03a775-e930-47e7-b228-9f0a8202b801
size(mandril_prop)
...
dx = Lx / size(mandril_large, 1)

# ╔═╡ 008388f4-4096-41e3-8ba5-11329f139098
2 * dx^2 / λ

# ╔═╡ e25f5105-e5d1-494f-8709-d265138dc176
λ / (1 - √(1 - λ^2 / (64 * dx)^2))
...
aperture = box((Nrec, Nrec), aperture_size);

# ╔═╡ 6095b2ae-b516-47ba-8301-159749f659d9
simshow(aperture)

# ╔═╡ 8ce4e662-1143-4fd8-98b8-ba0df79335ae
z_aperture = range(0, 80e-3, 100)

# ╔═╡ c3b363ee-5489-4e86-8849-14fbcac80a19
aperture_p = bpm(aperture, λ, Lrec, Lrec, z_aperture);
