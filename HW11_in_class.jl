...
# ╔═╡ dcdb28e7-aeff-476b-aafe-195cfc703278
size(sinogram1)

# ╔═╡ a008e4cd-1045-4fb1-89c3-8fbe285985b5
ramp = rr((size(sinogram1, 1), ))

# ╔═╡ 1154a3b9-14cc-44f9-b3df-cc87b5a33048
sinogram_filtered = real(ift(ft(sinogram2, 1) .* ramp, 1))

# ╔═╡ 3db8549d-3c60-448e-8086-707a1c6bf945
simshow(sinogram2)

# ╔═╡ d0ed14ee-9c1f-43d1-9cca-01ced7e9dc7d
heatmap(sinogram_filtered)

# ╔═╡ b3cea98e-0818-40a2-85ad-7f6e4ee26be8
object_filtered = backproject(sinogram_filtered, angles2);
...
angles_D1 = range(0, π, 100)

# ╔═╡ cd58b548-11c9-4d58-94e1-fc8f73e83b0b
angles_D2 =  range(0, π / 2, 100)

# ╔═╡ 8261983b-1908-4d64-84bc-54708e3c85b8
simshow(object)

# ╔═╡ 7e98ddae-b3ff-44d7-b664-3043691a97bf
@time out_scattered, out_diffraction = diffraction_tomography(object .* 1, λ, Lx, Ly, z, N, angles_D1);
...
# ╔═╡ 83b68b60-a664-4e6f-9993-54743621fc1c
simshow(backproject_filtered(abs.(out_scattered .- out_diffraction)[begin+1:end, :], angles_D1))

# ╔═╡ 11650de4-f082-4e6a-81ee-af6a7d17516e
size(out_scattered)

# ╔═╡ 114fd93e-5e35-4618-ba66-49192357176b
heatmap(object .+ 1)
